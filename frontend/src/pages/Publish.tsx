				...
				<div className='max-w-screen-lg w-full'>
					<input
						...
						className='bg-gray-50 border border-gray-300 
                            text-gray-900 text-sm rounded-lg focus:ring-blue-100 
                            focus:border-blue-500 block w-full p-2.5 focus:outline-none'
						placeholder='Title'
					/>
					<div className='pt-4'>
						<Texteditor
					...
					<button
						...
						type='submit'
						className='inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-1 focus:ring-blue-200 '
					>
						Publish post
					</button>
				</div>
